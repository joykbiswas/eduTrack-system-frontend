...
} from "@/app/(dashboardLayout)/teacher/dashboard/word-story-cards-create/_actions";
import {
  IAssessment,
  IMaterial,
  IQuiz,
  IWordStoryCard,
} from "@/types/word-story.types";
...
export function WordStoryCardDataTable() {
  ...
  const [showAssessmentAnswers, setShowAssessmentAnswers] = useState<
    Record<string, boolean>
  >({});
  ...
  const toggleAllAssessmentAnswers = (
    assessmentId: string,
      ...
      cell: ({ row }) => (
        <div className="flex items-center gap-1">
          ...
          <span className="text-sm">
            {row.original.assessments?.length || 0}
          </span>
        </div>
      ),
    },
        ...
        <div className="border-b bg-white p-4">
          ...
          <div className="mt-2 space-y-2">
            <div className="text-sm p-2 bg-slate-50 rounded">
              ...
              {card.dialogContent.dialog1}
            </div>
            <div className="text-sm p-2 bg-slate-50 rounded">
              <span className="font-medium">Q2:</span>{" "}
              {card.dialogContent.dialog2}
            </div>
            <div className="text-sm p-2 bg-slate-50 rounded">
              <span className="font-medium">Q3:</span>{" "}
              {card.dialogContent.dialog3}
            </div>
          </div>
        </div>
                  ...
                  >
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground line-clamp-3 break-words whitespace-normal">
                          {material.content}
                        </p>
                      </div>
                    </div>
                        ...
                        >
                          <div className="flex items-start justify-between">
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                toggleAssessmentAnswer(assessment.id, idx)
                              }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage all word story cards and their content
          </p>
        </div>
